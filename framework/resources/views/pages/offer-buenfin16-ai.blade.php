...
@section('title', 'Buen Fin - Hoteles Todo Incluido')

@section('metadescription','Reserva este Buen Fin las vacaciones que tanto has querido para disfrutar con tu familia hoteles todo incluido en Cancún.')
@section('og_title', 'Buen Fin - Hoteles Todo Incluido')
@section('og_image', asset('img/small/buen-fin-hoteles-todo-incluido-2016-es.jpg')) 
      ...
      <div>
        ...
        <div class="col-lg-3 col-md-2 col-sm-12 col-xs-12 bookesp"> 
          ...
          <select class="form-control" id="hotelid" name="hotelid" onchange="validateBooking();">  
            <option value="73601" id="2186425" data-subtext="Cancun Hotel Zone" name="1">The Royal Cancun All Suites  Resort</option>  
            <option value="86169" id="2186440" data-subtext="Cancun Hotel Zone" name="1">The Royal Sands Resort &amp; Spa All Inclusive</option>  
            <option value="86184" id="2186926" data-subtext="Playa del Carmen" name="1">The Royal Haciendas All Suites Resort &amp; Spa</option>  
          </select> 
        </div>  
...
<div class="container">
  ...
  <div class="row">
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
      <img class="img-responsive margint50 marco" src="{{ asset('img/big/buen-fin-hoteles-todo-incluido-2016-es.jpg')}}" alt="Buen Fin - Hoteles Todo Incluido">
    </div>
  </div>
  ...
  <div class="row marginb50">
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
      <h1>Buen Fin - Hoteles Todo Incluido en Cancún</h1>
    </div>
    <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
      <div id="overview">
        <p>
         Este Buen Fin 2016, podrás comprar la pantalla plana que tanto has querido o la sala de tus sueños. ¿Por qué no incluir tus próximas vacaciones al Caribe en tu lista de Buen Fin 2016 también?  Disfruta inigualables amenidades y servicios de nuestros resorts en Cancún y Playa del Carmen, los mejores destinos del Caribe Mexicano, con ahorros importantes de hasta 55% de descuento.  
        </p>
        ...
        <ul>
          <li>Plan Todo Incluido: alimentos, bebidas, actividades y más.</li>
        ...
        <ul>
          <li>The Royal Cancun All Suites Resort</li>
          <li>The Royal Sands Resort & SPA All Inclusive</li>
          <li>The Royal Haciendas All Suites Resort & SPA</li>
        </ul>
      </div>
    </div>
...
<div class="container">
  <div class="row">
      ...
      <a href="https://royalreservations.com/resorts/the-royal-cancun"><img class="img-responsive marco" src="https://royalreservations.com/img/small/the-royal-cancun-1.jpg" alt="Perfect all inclusive vacations at The Royal Cancun pool"></a>
            <div class="resort-all-room"></div>
            <div class="marcoInferior marginb100">
        <a href="https://royalreservations.com/resorts/the-royal-cancun" class="offersHotels"><span>The Royal Cancun All Suites  Resort</span></a>
    ...
    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 resort-small">
      <a href="https://royalreservations.com/resorts/the-royal-sands"><img class="img-responsive marco" src="https://royalreservations.com/img/small/the-royal-sands-1.jpg" alt="The Royal Sands All inclusive resort in Cancun"></a>
            <div class="resort-all"></div>
            <div class="marcoInferior marginb100">
        <a href="https://royalreservations.com/resorts/the-royal-sands" class="offersHotels"><span>The Royal Sands Resort &amp; Spa All Inclusive</span></a>
        <div class="resort_stars">
                                <i class="fa fa-star"></i>
                                  <i class="fa fa-star"></i>
                                  <i class="fa fa-star"></i>
    ...
    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 resort-small">
      <a href="https://royalreservations.com/resorts/the-royal-haciendas"><img class="img-responsive marco" src="https://royalreservations.com/img/small/the-royal-haciendas-1.jpg" alt="All inclusive Playa del carmen vacations"></a>
            <div class="resort-all-room"></div>
            <div class="marcoInferior marginb100">
        <a href="https://royalreservations.com/resorts/the-royal-haciendas" class="offersHotels"><span>The Royal Haciendas All Suites Resort &amp; Spa</span></a>
        <div class="resort_stars">
                                <i class="fa fa-star"></i>
                                  <i class="fa fa-star"></i>
                                  <i class="fa fa-star"></i>
