...
<div class="carousel-inner txtBanner" role="listbox">
	<div class="item active">
		<img class="img-responsive" src="{{asset((Agent::isMobile() && !Agent::isTablet()) ? 'img/medium/'.$page->identifier.'-'.App::getLocale().'.jpg':'img/big/'.$page->identifier.'-'.App::getLocale().'.jpg')}}" alt="{{$page->alt8}}">
...
<div class="container">
	<div class="row">
		...
		<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
			<img class="img-responsive marco" src="{{asset((Agent::isMobile() && !Agent::isTablet()) ? 'img/small/'.$page->identifier.'-1.jpg':'img/medium/'.$page->identifier.'-1.jpg')}}" alt="{{$page->alt1}}">
		</div>
		...
		<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
			<img class="img-responsive marco" src="{{asset((Agent::isMobile() && !Agent::isTablet()) ? 'img/small/'.$page->identifier.'-2.jpg':'img/medium/'.$page->identifier.'-2.jpg')}}" alt="{{$page->alt2}}">
		</div>
		<div class="clearfix"></div>
		@endif
		@if($page->div3 !='')
		...
		<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 mb50">
			<img class="img-responsive marco" src="{{asset((Agent::isMobile() && !Agent::isTablet()) ? 'img/small/'.$page->identifier.'-3.jpg':'img/medium/'.$page->identifier.'-3.jpg')}}" alt="{{$page->alt3}}">
		</div>
		...
		<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 mb50">
			<img class="img-responsive marco" src="{{asset((Agent::isMobile() && !Agent::isTablet()) ? 'img/small/'.$page->identifier.'-4.jpg':'img/medium/'.$page->identifier.'-4.jpg')}}" alt="{{$page->alt4}}">
		</div>
		@endif
		@if($page->div5 !='')
		<div class="clearfix"></div>
		<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 mb50">
			<img class="img-responsive marco" src="{{asset((Agent::isMobile() && !Agent::isTablet()) ? 'img/small/'.$page->identifier.'-5.jpg':'img/medium/'.$page->identifier.'-5.jpg')}}" alt="{{$page->alt5}}">
		</div>
		<div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
