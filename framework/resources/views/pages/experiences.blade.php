...
<div class="container">
	<div class="row">
		...
		<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 experience">
			<a href="{{url(App::getLocale() =='en'? Lang::get('routes.experiences').'/'.$experience->identifier : 'es/'.Lang::get('routes.experiences').'/'.$experience->identifier)}}"> 
			...
			<div class="marcoInferior marginb50">
				<span class="tituloHoteles"><a href="{{url(App::getLocale()=='en'?Lang::get('routes.experiences').'/'.$experience->identifier:'/es/'.Lang::get('routes.experiences').'/'.$experience->identifier)}}">{{ $experience->contents[0]->name }}</a></span>
