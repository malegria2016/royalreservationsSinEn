...
<html lang="en">
	...
	<head>
		...
		<meta property="og:url" content="https://royalreservations.com/en/packages/chichen-itza" />
				...
				<div class="container">
					<div class="container">
						<div class="navbar-header">
							<a class="navbar-brand" href="https://royalreservations.com/en">
			...
			<div class="row">
				<div class="col-lg-5 col-md-5 col-sm-4 col-xs-12">
					<div id="overview" class="text-justify">
						...
						<ul>
							<li><a href="{{url(App::getLocale().'/'.Lang::get('routes.resorts').'/grand-residences')}}">Grand Residences Riviera Cancun Resort</a></li>
							<li><a href="{{url(App::getLocale().'/'.Lang::get('routes.resorts').'/the-royal-haciendas')}}">The Royal Haciendas All Suites Resort & Spa</a></li>
							<li><a href="{{url(App::getLocale().'/'.Lang::get('routes.resorts').'/the-royal-sands')}}">The Royal Sands Resort & SPA All Inclusive</a></li>
							<li><a href="{{url(App::getLocale().'/'.Lang::get('routes.resorts').'/the-royal-islander')}}">The Royal Islander, An All Suites Resort</a></li>
							<li><a href="{{url(App::getLocale().'/'.Lang::get('routes.resorts').'/the-royal-caribbean')}}">The Royal Caribbean, An All Suites Resort</a></li>
							<li><a href="{{url(App::getLocale().'/'.Lang::get('routes.resorts').'/the-royal-cancun')}}">The Royal Cancun All Suites Resort</a></li>
						</ul>
						<strong>@lang('messages.caribbean')</strong>
						<ul>
							<li><a href="{{url(App::getLocale().'/'.Lang::get('routes.resorts').'/simpson-bay-resort-and-marina')}}">Simpson Bay Resort and Marina</a></li>
							<li><a href="{{url(App::getLocale().'/'.Lang::get('routes.resorts').'/the-villas-at-simpson-bay-resort-and-marina')}}">The Villas at Simpson Bay Resort & Marina</a></li>
							<li><a href="{{url(App::getLocale().'/'.Lang::get('routes.resorts').'/the-royal-sea-aquarium')}}">The Royal Sea Aquarium Resort</a></li>
						</ul>
					</div>
				</div>
				<div class="col-lg-5 col-md-5 col-sm-4 col-xs-12">
					<div id="overview" class="text-justify">
						...
						<ul>
							<li><a href="{{url(App::getLocale().'/'.Lang::get('routes.all-inclusive'))}}">@lang('messages.tx_refine')</a></li>
							<li><a href="{{url(App::getLocale().'/'.Lang::get('routes.all-inclusive'))}}">All-in Grand Experience</a></li>
							<li><a href="{{url(App::getLocale().'/'.Lang::get('routes.all-inclusive'))}}">@lang('messages.tx_allinc')</a></li>
						</ul>
						<strong>@lang('messages.offers')</strong>
						<ul>
							<li><a href="{{url(App::getLocale().'/'.Lang::get('routes.offers'))}}">{{  (App::getLocale()=='es')? 'Todas las ':'All '}} @lang('messages.offers')</a></li>
						</ul>
						<strong>@lang('messages.tx_packages')</strong>
						<ul>
							<li><a href="{{url(App::getLocale().'/'.Lang::get('routes.offers'))}}">{{  (App::getLocale()=='es')? 'Todos los ':'All '}} @lang('messages.tx_packages')</a></li>
						</ul>
				...
				<div class="col-lg-2 col-md-2 col-sm-4 col-xs-12">
					<div id="terms" class="text-center">
						<a href="{{url(App::getLocale().'/')}}"><img src=" https://royalreservations.com/img/general/logo-royal-404.png " alt="Royal Reservations"></a>
					</div>
					
					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center margint50"> 
						<a href="{{url(App::getLocale().'/')}}" class="btn btn-danger">@lang('messages.tx_home')</a>
					</div>
