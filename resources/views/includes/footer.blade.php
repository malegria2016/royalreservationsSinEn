		<footer>
			...
			<div id="cookie-law-info-bar" class="cookies-policy"><span>@lang('messages.cookie_tx')<button id="cerrar" class="margin15">@lang('messages.cookie_btn')</button><a href="{{url(App::getLocale().'/'.Lang::get('routes.cookies-policy'))}}" target="_new">@lang('messages.cookie_link')</a>.</span>
			</div>
				...
				<div class="row">
					...
					<div class="col-md-2 listados">
						<ul>
							...
							<li><a href="{{url(App::getLocale().'/'.Lang::get('routes.contact'))}}">@lang('messages.about_us')</a></li>
							<li><a href="{{url(App::getLocale().'/'.Lang::get('routes.contact'))}}">@lang('messages.legal_notice')</a></li>
							<li><a href="{{url(App::getLocale().'/'.Lang::get('routes.contact'))}}">@lang('messages.privacy_policy')</a></li>
						</ul>
					</div>
				</div>
			</div>
