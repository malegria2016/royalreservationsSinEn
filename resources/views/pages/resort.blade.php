...
<div class="container">
	<div class="row margint30">
		<div class="col-lg-12 col-md-12 col-sm-12 hidden-xs btnHotel">
			<!--<button id="btn-offer" type="button" class="btn btn-resorts btn-lg"><i class="fa fa-tag fac"></i> @lang('messages.offers')</button>-->
			<a href="{{url('/'.App::getLocale().'/'.Lang::get('routes.offers').'/resorts/'.$resort->identifier)}}" class="btnOfferResort"><i class="fa fa-tag fac"></i> @lang('messages.offers')</a>
	...
	<!-- SECCION HOTEL OFFERS -->
	<div id="offer" class="row">
		<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 margint50 marginb50 text-center">
			{!! $resort->contents[0]->offer !!}
			<a href="{{url(App::getLocale().'/'.Lang::get('routes.offers').'/'.Lang::get('routes.resorts').'/'.$resort->identifier)}}" class="btn btn-danger btn-lg pull-right">@lang('messages.more_offers')</a>
		</div>
		<div class="clearfix"></div>
		@if(count($offers)> 0)
