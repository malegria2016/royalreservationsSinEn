...
<div class="container">
	...
	<div class="row" id="mex">
		...
		<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 destination">
			<a href="{{url(App::getLocale().'/'.Lang::get('routes.destinations').'/'.$destination->identifier)}}"> 
			...
			<div class="marcoInferior marginb50">
				<span class="tituloHoteles"><a href="{{url(App::getLocale().'/'.Lang::get('routes.destinations').'/'.$destination->identifier)}}">{{ $destination->name }}</a></span>
